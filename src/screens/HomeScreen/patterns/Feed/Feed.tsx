    ...
    >
      ...
      >
        <Image
          ...
          alt="Imagem de perfil do Péricles"
        />
        ...
        >
          <Box styleSheet={{ flex: 1, justifyContent: 'space-between', display: { xs: 'none', md: 'flex' } }}>
            <Button fullWidth colorVariant="primary" size="xl" href="/newslatter">Newsletter</Button>
          ...
          <Box styleSheet={{ flex: 1, justifyContent: 'space-between', display: { xs: 'flex', md: 'none' } }}>
            <Button fullWidth colorVariant="primary" size="xs" href="/newslatter">Newsletter</Button>
